...
{
    public partial class CreateGameShopDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeStore", x => new { x.EmployeesEmployeeId, x.StoresStoreId });
                    table.ForeignKey(
                        name: "FK_EmployeeStore_Employees_EmployeesEmployeeId",
                        column: x => x.EmployeesEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeStore_Stores_StoresStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStore_StoresStoreId",
                table: "EmployeeStore",
